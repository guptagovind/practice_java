...
public class NumberToWords {
    public static int reverse(int num) {
        ...
        return assignSign * reverseNumber;
    }
    ...
    public static void numberToWords(int num) {
        ...
        while (reverseNumber > 0) { //100
            // printNumberInWord(reverseNumber%10);
        ...
        if (digitCount != reverseNumberDigitCount) {
            while (digitCount > reverseNumberDigitCount) {
                System.out.println("Zero");
                digitCount--;
            }
